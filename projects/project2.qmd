...
This visualization shows the annual breakdown of total sales across 2018–2020, highlighting **peak periods and overall recovery trends** post-seasonal dips.

![Sales per Year](../sales_per_year.png)

## 🏷️ Sales by Product Line

Here we identify top-performing vehicle lines. **Classic Cars** lead in revenue, while **Motorcycles** and **Vintage Cars** follow, indicating consistent premium interest.

![Sales per Product Line](../sales_per_product_line.png)

# 📦 Download Files

<a href="../PowerBI%20Presentation%20FOR%20GROUP%203%20(2).pbix" class="btn btn-primary mt-2" download>📥 Download Power BI Dashboard (PBIX)</a>
